...
> the `30pct` subfolder. Load it directly with
> `PeftModel.from_pretrained(model, "Psycodem/qwen3.5-4b-lora-diacritization", subfolder="30pct")`
> instead of copying these files.

# Qwen/Qwen3.5-4B + LoRA for Arabic Diacritisation (30% of the training corpus)
...
|---|---:|---:|---:|---:|---:|
| Train sample | 500 | 1.78 | 1.63 | 3.26 | 2.2 |
| Sadeed Tashkeela test | 2,485 | 13.93 | 13.42 | 16.89 | 14.17 |
| **SadeedDiac-25 benchmark** | **1,200** | **5.27** | **5.03** | **9.28** | **6.54** |
...
Trained on a 30% subset of `Misraj/Sadeed_Tashkeela` (312,809 rows), drawn with
...
| Warmup | 5% of total steps (162 of 3,259) |
| Epochs | 1 |
| Max sequence length | 1024 |
| Seed | 42 |
| Run on | Ibex (job 50682302, 12:48:14) |
...
Launcher: `ibex_config/run_qwen_lora_30pct.sbatch` in the project repository.
