...
> **On the Hugging Face Hub:** [`Psycodem/qwen3.5-4b-lora-diacritization`](https://huggingface.co/Psycodem/qwen3.5-4b-lora-diacritization) — this adapter is
> the `50pct` subfolder. Load it directly with
> `PeftModel.from_pretrained(model, "Psycodem/qwen3.5-4b-lora-diacritization", subfolder="50pct")`
> instead of copying these files.

# Qwen/Qwen3.5-4B + LoRA for Arabic Diacritisation (50% of the training corpus)
...
|---|---:|---:|---:|---:|---:|
| Train sample | 500 | 1.94 | 1.82 | 3.38 | 2.49 |
| Sadeed Tashkeela test | 2,485 | 13.74 | 13.24 | 16.48 | 13.89 |
| **SadeedDiac-25 benchmark** | **1,200** | **4.38** | **4.07** | **8.18** | **5.57** |
...
Trained on a 50% subset of `Misraj/Sadeed_Tashkeela` (521,349 rows), drawn with
...
| Warmup | 5% of total steps (271 of 5,431) |
| Epochs | 1 |
| Max sequence length | 1024 |
| Seed | 42 |
| Run on | Ibex (job 50676206, 20:09:37) |
...
Launcher: `ibex_config/run_qwen_lora_50pct.sbatch` in the project repository.
