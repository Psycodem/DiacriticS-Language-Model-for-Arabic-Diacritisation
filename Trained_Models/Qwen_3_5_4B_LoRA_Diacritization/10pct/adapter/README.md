...
> `PeftModel.from_pretrained(model, "Psycodem/qwen3.5-4b-lora-diacritization", subfolder="10pct")`
> instead of copying these files.

# Qwen/Qwen3.5-4B + LoRA for Arabic Diacritisation (10% of the training corpus)
...
|---|---:|---:|---:|---:|---:|
| Train sample | 500 | 1.36 | 1.13 | 3.52 | 2.1 |
| Sadeed Tashkeela test | 2,485 | 14.24 | 13.74 | 17.62 | 14.74 |
| **SadeedDiac-25 benchmark** | **1,200** | **7.07** | **6.94** | **11.74** | **8.74** |
...
Launcher: `modal_config/modal_train.py --model qwen` in the project repository.
