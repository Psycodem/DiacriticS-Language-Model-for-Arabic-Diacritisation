...
> `PeftModel.from_pretrained(model, "Psycodem/gemma-4-e4b-lora-diacritization", subfolder="50pct")`
> instead of copying these files.

# google/gemma-4-E4B-it + LoRA for Arabic Diacritisation (50% of the training corpus)
...
|---|---:|---:|---:|---:|---:|
| Train sample | 500 | 1.76 | 1.62 | 3.19 | 2.27 |
| Sadeed Tashkeela test | 2,485 | 12.57 | 12.05 | 15.41 | 12.72 |
| **SadeedDiac-25 benchmark** | **1,200** | **2.81** | **2.38** | **6.54** | **3.96** |
...
| Seed | 42 |
| Run on | Ibex (job 50682300, 13:46:11) |
...
Launcher: `ibex_config/run_gemma_lora_50pct.sbatch` in the project repository.
