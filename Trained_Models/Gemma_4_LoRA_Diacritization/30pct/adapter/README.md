...
> `PeftModel.from_pretrained(model, "Psycodem/gemma-4-e4b-lora-diacritization", subfolder="30pct")`
> instead of copying these files.

# google/gemma-4-E4B-it + LoRA for Arabic Diacritisation (30% of the training corpus)
...
|---|---:|---:|---:|---:|---:|
| Train sample | 500 | 1.81 | 1.64 | 3.54 | 2.33 |
| Sadeed Tashkeela test | 2,485 | 12.73 | 12.21 | 15.73 | 12.94 |
| **SadeedDiac-25 benchmark** | **1,200** | **2.98** | **2.54** | **6.82** | **4.12** |
...
| Seed | 42 |
| Run on | Ibex (job 50765898, 09:27:39) |
...
Launcher: `ibex_config/run_gemma_lora_30pct.sbatch` in the project repository.
