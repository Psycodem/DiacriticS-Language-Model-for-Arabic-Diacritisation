...
export const copy = {
  ...
  ar: {
    ...
    fineTuning: {
      ...
      intro: "جرى ضبط النموذجين بحجم أربعة مليارات معامل بطريقة LoRA تحت ظروف متطابقة على شرائح متداخلة من بيانات التدريب، بحيث تقع شريحة ١٠٪ داخل ٣٠٪ وهذه داخل ٥٠٪. والاختلاف الوحيد هو حجم البيانات والبنية الأساسية.",
      ...
      footnote: "مُحوّل LoRA برتبة ١٦، وحجم دفعة فعّال ٩٦، ودورة تدريب واحدة، وإحماء بنسبة ٥٪، وبذرة عشوائية ٤٢، على مجموعات متداخلة من بيانات سديد تشكيلة. يتفوّق جيما في كل النسب، لكن الفارق يضيق من ٥٤٫١ نقطة إلى ١٫٦.",
      ...
      regimeFoot: "يتفوّق الضبط الكامل بفارق ٠٫٥٤ نقطة فقط. وهذا الفارق الضيّق هو النتيجة نفسها: إذ يستعيد مُحوّل LoRA برتبة ١٦ نحو ٩٤٪ من فائدة تحديث كل الأوزان. وقد قُيّمت تجربة LoRA على المعيار وحده.",
      findings: [
        { tag: "النتيجة الثالثة", title: "النموذج الأضعف هو الأكثر استفادة", body: "ينخفض نموذج Qwen3.5-4B من ٥٨٫٢٩٪ إلى ٤٫٣٨٪، و٥١٫٢ نقطة من أصل ٥٤ تتحقق من عُشر البيانات الأول وحده. أما Gemma 4 E4B-it فيبدأ من ٤٫١٨٪، أي أقل مما ينتهي إليه Qwen، ويصل إلى ٢٫٨١٪.", example: "٥٨٫٢٩ ← ٤٫٣٨", gloss: "‏Qwen3.5-4B من دون تدريب إلى نصف البيانات" },
        { tag: "النتيجة الرابعة", title: "الحجم ليس القيد الحاسم", body: "يصل نموذج بحجم ٠٫٨ مليار معامل مُدرَّب بالكامل إلى ٣٫٠٦٪، متفوّقًا على نموذج بأربعة مليارات معامل جرى ضبطه بطريقة LoRA على نصف البيانات، وبخُمس عدد المعاملات. فنسبة الأوزان القابلة للتغيّر أهم من حجم النموذج.", example: "٣٫٠٦ < ٤٫٣٨", gloss: "الضبط الكامل لـ ٠٫٨ مليار مقابل LoRA لأربعة مليارات" },
      ] satisfies Finding[],
    },
    analysis: {
